...
>
> **현재 상태** — 와이어프레임 전 화면(01–16)과 관리자 AI 어시스턴트(17) 구현. 실 BE 연동 전까지 **MSW**로 전 플로우가 동작한다.
...
와이어프레임 전 화면(01–16)과 관리자 AI 어시스턴트(17)가 구현되었다. 와이어프레임은 "무엇을 담을지"의 참고일 뿐, **실제 배치·동작·표기는 코드가 기준**이다.
